...
const paneles = () => {
    ...
    if (mediaQueryDesktop.matches) {
        // console.log("m");
        const template = `<div class="heading" id="heading4"><div class="historia__panel"></div></div><div class="heading" id="heading5"><div class="historia__panel"></div></div><div class="heading" id="heading6"><div class="historia__panel"></div></div>`;
        headingSection.insertAdjacentHTML("beforeend", template);

        document
            .querySelector("#heading2")
            .querySelector(".historia__panel")
            .insertAdjacentElement("afterbegin", cajaHeading[1]);
        document
            .querySelector("#heading3")
            .querySelector(".historia__panel")
            .insertAdjacentElement("afterbegin", cajaHeading[2]);
        document
            .querySelector("#heading4")
            .querySelector(".historia__panel")
            .insertAdjacentElement("afterbegin", cajaHeading[3]);

        document
            .querySelector("#heading5")
            .querySelector(".historia__panel")
            .insertAdjacentElement("afterbegin", cajaHeading[4]);
    } else {
    }
